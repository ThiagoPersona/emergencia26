...
1. `2025-pocus-aaa-acesso`: o manifesto descreve `us-aaa-sacular-flap` como aneurisma sacular com flap, enquanto o checklist histórico imutável exige “trombo mural”. A mídia deve passar por revisão médica visual antes de uso avaliativo para confirmar que sustenta todos os achados pontuados; o checklist não foi alterado.
2. Os checklists históricos preservam alvos específicos que podem variar entre protocolos, especialmente PaCO2 35-38 mmHg, plaquetas acima de 100.000/mm³ e INR abaixo de 1,5 no TCE, atropina pediátrica e esquema de ácido tranexâmico/transfusão no trauma.
3. Doses de indução, vasopressores, fluidos, antitrombóticos e bloqueio neuromuscular exigem individualização. A redação nova explicita protocolo local e reavaliação quando a pesquisa não sustenta um valor universal.
4. Cricotireoidostomia, descompressão torácica e pericardiocentese dependem de habilitação, equipamento e protocolo institucional; as estações pressupõem manequim ou equipe habilitada e não devem ser usadas como instrução autônoma de procedimento.
5. Antes de publicação, permanece indicada revisão médica institucional brasileira de disponibilidade de hemoderivados, antídotos, vasopressores, dispositivos e fluxos de transferência.
