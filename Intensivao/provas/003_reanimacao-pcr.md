...
<ul class="quiz-explain">
<li><strong>A.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “Alteplase EV”</li>
<li><strong>B.</strong> Não é a melhor resposta. Erro da alternativa: não conversa com o dado-chave do enunciado; ela desloca o foco para uma conduta, diagnóstico ou detalhe menos provável que o cobrado pela banca. Alternativa: “Toracotomia de reanimação”</li>
<li><strong>C.</strong> Não é a melhor resposta. Erro da alternativa: não conversa com o dado-chave do enunciado; ela desloca o foco para uma conduta, diagnóstico ou detalhe menos provável que o cobrado pela banca. Alternativa: “Toracocentese de alívio”</li>
<li><strong>D.</strong> Não é a melhor resposta. Erro da alternativa: interpreta o exame fora da pergunta clínica; POCUS deve ligar achado, contexto e decisão imediata, não apenas nomear uma imagem. Alternativa: “Pericardiocentese de alívio”</li>
</ul>
</div>
</div>
...
<ul class="quiz-explain">
<li><strong>A.</strong> Não é a melhor resposta. Erro da alternativa: erra a regra operacional/ética: segurança, comunicação, registro, regulação e responsabilidade médica não podem ser suprimidos. Alternativa: “Por não haver lesões externas, pode constatar o óbito e realizar a declaração de óbito;”</li>
<li><strong>B.</strong> Não é a melhor resposta. Erro da alternativa: erra a regra operacional/ética: segurança, comunicação, registro, regulação e responsabilidade médica não podem ser suprimidos. Alternativa: “Por não haver lesões externas, pode constatar o óbito e encaminhar o corpo ao serviço de verificação de óbito (SVO);”</li>
<li><strong>C.</strong> Não é a melhor resposta. Erro da alternativa: usa uma regra absoluta ou uma negação ampla demais; em emergência, indicação e contraindicação dependem de contexto, estabilidade e risco imediato. Alternativa: “Pode somente constatar o óbito;”</li>
<li><strong>D.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “Pode constatar o óbito e por não poder descartar causa externa do óbito, encaminhar ao Instituto Médico Legal (IML).”</li>
</ul>
</div>
</div>
...
<ul class="quiz-explain">
<li><strong>A.</strong> <strong>Correta como resposta ao comando.</strong> A questão pede a alternativa incorreta/exceção; esta é a opção que contém o problema cobrado: “V-V-F-V-F”</li>
<li><strong>B.</strong> Não deve ser marcada. O erro ao escolhê-la é de leitura do comando: esta afirmativa não é a incorreta/exceção que a banca pediu. Compare com a letra A, que contém o problema do item. Alternativa: “F-V-F-V-F”</li>
<li><strong>C.</strong> Não deve ser marcada. O erro ao escolhê-la é de leitura do comando: esta afirmativa não é a incorreta/exceção que a banca pediu. Compare com a letra A, que contém o problema do item. Alternativa: “V-V-V-F-V”</li>
<li><strong>D.</strong> Não deve ser marcada. O erro ao escolhê-la é de leitura do comando: esta afirmativa não é a incorreta/exceção que a banca pediu. Compare com a letra A, que contém o problema do item. Alternativa: “F-F-F-V-V”</li>
</ul>
</div>
</div>
...
<ul class="quiz-explain">
<li><strong>A.</strong> Não é a melhor resposta. Erro da alternativa: não ajusta bem a ressuscitação ao fenótipo do choque/infecção; volume, vasopressor e antimicrobiano dependem de perfusão, foco e tempo. Alternativa: “A infusão contínua de vasopressores não deve ser utilizada em parada cardiorrespiratória, optando-se por medicações em bólus.”</li>
<li><strong>B.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “Pode-se realizar a trombólise durante a reanimação cardiopulmonar, preferencialmente nos 10 primeiros minutos de parada cardiorrespiratória.”</li>
<li><strong>C.</strong> Não é a melhor resposta. Erro da alternativa: usa uma regra absoluta ou uma negação ampla demais; em emergência, indicação e contraindicação dependem de contexto, estabilidade e risco imediato. Alternativa: “Está contraindicada a trombólise nos pacientes comatosos após retorno à circulação espontânea mesmo que a suspeita seja de parada cardiorrespiratória por causa cardíaca.”</li>
<li><strong>D.</strong> Não é a melhor resposta. Erro da alternativa: não respeita o momento do algoritmo de reanimação/arritmia; ritmo, estabilidade, choque, droga e busca de causa reversível têm sequência própria. Alternativa: “Em pacientes com cardioversor/desfibrilador implantado não se deve realizar desfibrilação elétrica pelo risco de disfunção do aparelho.”</li>
</ul>
</div>
</div>
...
<ul class="quiz-explain">
<li><strong>A.</strong> Não é a melhor resposta. Erro da alternativa: desalinha controle de dano e ressuscitação hemostática; a prova cobra controle precoce de sangramento, proporção adequada e correção de coagulopatia. Alternativa: “A presença de distensão jugular confirma tamponamento cardíaco.”</li>
<li><strong>B.</strong> Não é a melhor resposta. Erro da alternativa: não respeita o momento do algoritmo de reanimação/arritmia; ritmo, estabilidade, choque, droga e busca de causa reversível têm sequência própria. Alternativa: “A pericardiocentese é um tratamento eficaz para parada cardiorrespiratória (PCR) por tamponamento cardíaco traumático.”</li>
<li><strong>C.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “A presença de baixa voltagem na cardioscopia é achado compatível com tamponamento cardíaco traumático.”</li>
<li><strong>D.</strong> Não é a melhor resposta. Erro da alternativa: usa uma regra absoluta ou uma negação ampla demais; em emergência, indicação e contraindicação dependem de contexto, estabilidade e risco imediato. Alternativa: “A toracotomia de reanimação deve ser realizada sempre que a causa da PCR for tamponamento cardíaco.”</li>
</ul>
</div>
</div>
...
<ul class="quiz-explain">
<li><strong>A.</strong> Não é a melhor resposta. Erro da alternativa: subestima gravidade ou risco de deterioração; alta/observação só entram quando sinais de alarme e critérios de segurança foram resolvidos. Alternativa: “Fornecer a Declaração de Óbito com a causa da morte CID 10 R96 – Outras mortes súbitas de causa desconhecida – e liberar o corpo para a família, orientando sobre os trâmites funerários.”</li>
<li><strong>B.</strong> Não é a melhor resposta. Erro da alternativa: erra a regra operacional/ética: segurança, comunicação, registro, regulação e responsabilidade médica não podem ser suprimidos. Alternativa: “Notificar o Serviço de Verificação de Óbito (SVO) para que realize a necropsia e emita a Declaração de Óbito, dada a causa desconhecida e a idade avançada do paciente.”</li>
<li><strong>C.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “Providenciar o encaminhamento do corpo ao Instituto Médico Legal e registrar detalhadamente todos os achados no prontuário.”</li>
<li><strong>D.</strong> Não é a melhor resposta. Erro da alternativa: erra a regra operacional/ética: segurança, comunicação, registro, regulação e responsabilidade médica não podem ser suprimidos. Alternativa: “Realizar uma reunião com a família para discutir o histórico clínico do paciente e preencher a Declaração de Óbito com base em comorbidades relatadas.”</li>
</ul>
</div>
</div>
