...
<ul class="quiz-explain">
<li><strong>A.</strong> Não é a melhor resposta. Erro da alternativa: interpreta o exame fora da pergunta clínica; POCUS deve ligar achado, contexto e decisão imediata, não apenas nomear uma imagem. Alternativa: “Variação do diâmetro da Veia Cava Inferior < 50% em pacientes em respiração espontânea”</li>
<li><strong>B.</strong> Não é a melhor resposta. Erro da alternativa: não ajusta bem a ressuscitação ao fenótipo do choque/infecção; volume, vasopressor e antimicrobiano dependem de perfusão, foco e tempo. Alternativa: “Variação do volume sistólico < 8% em pacientes em respiração espontânea”</li>
<li><strong>C.</strong> Não é a melhor resposta. Erro da alternativa: não conversa com o dado-chave do enunciado; ela desloca o foco para uma conduta, diagnóstico ou detalhe menos provável que o cobrado pela banca. Alternativa: “Variação do débito cardíaco > 5% com a elevação das pernas (PLR: Passive Leg Raising)”</li>
<li><strong>D.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “Variação do débito cardíaco > 6% após infusão de 100ml (desafio de mini fluido)”</li>
</ul>
</div>
</div>
...
<ul class="quiz-explain">
<li><strong>A.</strong> Não é a melhor resposta. Erro da alternativa: não fecha o diagnóstico sindrômico com os dados-chave; a banca favorece a hipótese que melhor explica fisiologia, tempo e sinais de gravidade. Alternativa: “Obstrutivo: TEP”</li>
<li><strong>B.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “Distributivo: Sepse”</li>
<li><strong>C.</strong> Não é a melhor resposta. Erro da alternativa: desalinha controle de dano e ressuscitação hemostática; a prova cobra controle precoce de sangramento, proporção adequada e correção de coagulopatia. Alternativa: “Hipovolêmico: Hemorragia”</li>
<li><strong>D.</strong> Não é a melhor resposta. Erro da alternativa: desalinha controle de dano e ressuscitação hemostática; a prova cobra controle precoce de sangramento, proporção adequada e correção de coagulopatia. Alternativa: “Obstrutivo: Tamponamento Cardíaco”</li>
</ul>
</div>
</div>
...
<ul class="quiz-explain">
<li><strong>A.</strong> Não é a melhor resposta. Erro da alternativa: não fecha o diagnóstico sindrômico com os dados-chave; a banca favorece a hipótese que melhor explica fisiologia, tempo e sinais de gravidade. Alternativa: “Gasometria Arterial deve ser solicitada para definir o diagnóstico etiológico desses pacientes.”</li>
<li><strong>B.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “Ultrassonografia Pulmonar pode auxiliar a introdução de medidas iniciais para esses paciente”</li>
<li><strong>C.</strong> Não é a melhor resposta. Erro da alternativa: coloca exame, confirmação ou etapa posterior no lugar da conduta inicial; a banca costuma punir atraso de intervenção tempo-dependente. Alternativa: “Prova de Função pulmonar é o exame de escolha para definir a causa de broncoespasmo no DE s”</li>
<li><strong>D.</strong> Não é a melhor resposta. Erro da alternativa: coloca exame, confirmação ou etapa posterior no lugar da conduta inicial; a banca costuma punir atraso de intervenção tempo-dependente. Alternativa: “A Tomografía de Tórax está indicada para pacientes com quadros de dispnéia crônica com piora aguda.”</li>
</ul>
</div>
</div>
...
<ul class="quiz-explain">
<li><strong>A.</strong> Não é a melhor resposta. Erro da alternativa: não conversa com o dado-chave do enunciado; ela desloca o foco para uma conduta, diagnóstico ou detalhe menos provável que o cobrado pela banca. Alternativa: “Comprimento de onda - Sombra acústica - Artefato de reverberação - Impedância acústica”</li>
<li><strong>B.</strong> Não é a melhor resposta. Erro da alternativa: não conversa com o dado-chave do enunciado; ela desloca o foco para uma conduta, diagnóstico ou detalhe menos provável que o cobrado pela banca. Alternativa: “Absorção de onda - Reforço acústico posterior - Reflexão/imagem em espelho Atenuação”</li>
<li><strong>C.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “Comprimento de onda - Reforço acústico posterior - Reflexão/imagem em espelho Impedância acústica”</li>
<li><strong>D.</strong> Não é a melhor resposta. Erro da alternativa: não conversa com o dado-chave do enunciado; ela desloca o foco para uma conduta, diagnóstico ou detalhe menos provável que o cobrado pela banca. Alternativa: “Absorção de onda - Sombra acústica - Artefato de reverberação - Interferência”</li>
</ul>
</div>
</div>
...
<ul class="quiz-explain">
<li><strong>A.</strong> Não é a melhor resposta. Erro da alternativa: interpreta o exame fora da pergunta clínica; POCUS deve ligar achado, contexto e decisão imediata, não apenas nomear uma imagem. Alternativa: “Colapso sistólico de ventrículo direito e veia cava inferior > 2 cm sem colapsibilidade.”</li>
<li><strong>B.</strong> Não é a melhor resposta. Erro da alternativa: não conversa com o dado-chave do enunciado; ela desloca o foco para uma conduta, diagnóstico ou detalhe menos provável que o cobrado pela banca. Alternativa: “Colapso sistólico do átrio direito e fluxo mitral sem variação à inspiração.”</li>
<li><strong>C.</strong> <strong>Correta.</strong> Esta alternativa fecha melhor o comando da questão e o gabarito oficial: “Colapso diastólico do ventrículo direito e colapso sistólico do átrio direito.”</li>
<li><strong>D.</strong> Não é a melhor resposta. Erro da alternativa: não conversa com o dado-chave do enunciado; ela desloca o foco para uma conduta, diagnóstico ou detalhe menos provável que o cobrado pela banca. Alternativa: “Colapso sistólico do ventrículo esquerdo e variação do fluxo mitral > 20% à inspiração.”</li>
</ul>
</div>
</div>
