...
flowchart TD
    ...
    B -->|Não| H{Dor abrupta rasgando ou déficit pulso/neuro?}
    H -->|Sim| I[Dissecção: beta-bloqueio, controle PA, angioTC/cirurgia]
    H -->|Não| J{Febre + sopro/risco?}
    J -->|Sim| K[Endocardite: culturas se possível + ATB + eco]
    J -->|Não| L[Pericardite/miocardite/TEV: estratificar e decidir destino]
```
